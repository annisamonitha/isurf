...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Channels</span> <span class="label label-important">V</span></a>
      <ul>
        <li><a href="{{ url('/channels/add-channels') }}">Add Channels</a></li>
        <li><a href="{{ url('/channels/add-field') }}">Add Field</a></li>
        <li><a href="{{ url('/channels/view-channel') }}">View Channels</a></li>
       </ul>
    </li>
