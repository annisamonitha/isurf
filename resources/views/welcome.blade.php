            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    ...
                    <li><a class="nav-link" href="/">Home</a></li>
                        <li><a class="nav-link" href="aboutme">About us</a></li>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="slide_text">
                                        <h3><span class="theme_color">ISURF</h3>
                                        <br>
                                        <h4>SMART URBAN<br>FARMING</h4>
                                        <br>
                                        <p>Smart Laboratorium of Agriculture 
                                            <br>in IPB University</p>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="slide_text">
                                        <h3><span class="theme_color">ISURF</h3>
                                        <br>
                                        <h4>SMART<br>AGRICULTURE</h4>
                                        <br>
                                        <p>Grow plan with the best nutrition
                                            <br>using internet of things technology</p>
                                        <a class="contact_bt" href="#">Contact us</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-12">
                    <div class="full center">
                        <div class="heading_main text_align_center">
                            <h2><span class="theme_color">GET TO KNOW</span> ABOUT US</h2>
                            <p class="large">We grow the best plant with the highest nutritioin</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="full">
                        ...
                        <div class="center">
                            <h4>Worked for Professionals</h4>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="full white_fonts text_align_center">
                                <p>Wing 20, Jl. Meranti Kampus IPB, Babakan, Kec. Dramaga, Bogor, Jawa Barat 16680
                                    <br>Indonesia</p>
                            </div>
                        </div>
                        <div class="col-md-4">
